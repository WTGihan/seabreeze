            ...
            $body = ' <!DOCTYPE html>
                    ...
                    <body>
                        <div class="wrapper" style=" width: 800px;">
                            ...
                            <p>You have one more step remaining to activate your SEABREEZE account. Click on the button below to verify your email address: <strong>This password reset is only valid for the next 24 hours.</strong></p> 
        ...
        function sendPasswordResultLink($userEmail, $token , $userName)
        {
            ...
            $body = ' <!DOCTYPE html>
                    ...
                    <body>
                        ...
                        width: 800px;">
                            <h1>Hi <strong> '. $userName .'</strong></h1>
                            <h3 class="top">You recently requested to reset your password for your SEABREEZE account Use the button below to reset it. <strong>This password reset is only valid for the next 24 hours.</strong></h3> 
