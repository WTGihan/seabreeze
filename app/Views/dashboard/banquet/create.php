<?php 
   // Header
   $title = "Add-Hall Reservation page";
...
<div class="wrapper">
    ...
    <?php 
            $navbar_title = "Hall Reservation Page";
            $search = 0;
            $search_by = '#';
            ...
            <div class="card">
                ...
                <div class="cardheader">
                    <div class="options">
                        ...
                        <a href="<?php url("newBanquet/search"); ?>" class="addnew"><i class="material-icons">reply_all</i></a>
                ...
                <div class="cardbody">  
                    ...
                    <form action="<?php url("newBanquet/create"); ?>" method="post" class="addnewform">
                    ...
                    <div class="section1">
                        ...
                        <div class="row">
                            <label for="#"><i class="material-icons">pending_actions</i>Session Type:</label>
                                <div class="animate-form">
                                    <select name="session_time" class="inputField" id="roomNumber" onchange="giveNoOfGuest()" required>
                        ...
                        <div class="rowdate">
                            <label for="#"><i class="material-icons">today</i>Session Date:</label>
                                <!-- <div class="animate-form"> -->
                                    <input type="date"  autocomplete="off" name="session_date" class="inputFieldDate" required
                                    <?php 
