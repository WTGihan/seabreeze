    ...
    <section class="bookingform">
            ...
            <div class="form">
                <div class="signredirect">
                    ...
                    <div class="description">
                        <div class="line1">
                            <span class="sign1">Welcome Our Seabreeze Hotel System!!</span>
                            <!-- <a href="#" class="sign2">Signin</a> -->
                        </div>
                        <span class="sign3">Reservae your Seabreeze hotel room and allows for faster bookings and more rewards</span>
                    </div>
                </div>
                <div class="contactdetails">
                    ...
                    <form action="<?php url("banquet/create"); ?>" method="post">
                
                
                        <!-- This is may reset according to form -->
                        <input type="hidden" name="session_date" value="<?php echo $reservation['check_in_date']; ?>">
                        <input type="hidden" name="session_time" value="<?php echo $reservation['session_type']; ?>">
                        <input type="hidden" name="hall_id" value="<?php echo $id; ?>">
                        <input type="hidden" name="price" value="<?php echo $reservation['price']; ?>">
                        <input type="hidden" name="hall_name" value="<?php echo $reservation['hall_name']; ?>">
        ...
        <aside class="roomdetails">
            <div class="detailsroom">
                <div class="dates">
                    <h4><span><i class="fa fa-calendar"></i>Session Date</span><?php echo $reservation['check_in_date']; ?></h4>
                ...
                <div class="roomrow">
                    ...
                    <h4><?php echo $reservation['hall_name']; ?></h4>
                </div>
            </div>

            <div class="detailsroomprice">
                <div class="priceroom">
                    <h4><span>Price(1 hall x 1 session)</span>$ <?php echo $reservation['price']; ?></h4>
                ...
                <?php 
                    if($reservation['session_type'] == "both") {
                        $total_price = $reservation['price']*2 + 4.83*2;
                    }
                    else {
                        $total_price = $reservation['price'] + 4.83;
                    }
