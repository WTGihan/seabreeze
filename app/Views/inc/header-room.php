...
<body>
    <div class="containerheader">
        ...
        <div class="slideshowContainer">
            ...
            <img class="imageSlides" src="<?php echo BURL.'assets/img/slideshow/room-slide1.jpg'; ?>"
                alt="beach side city view">
            <img class="imageSlides" src="<?php echo BURL.'assets/img/slideshow/room-slide2.jpg'; ?>"
                alt="beach side city view">
            <img class="imageSlides" src="<?php echo BURL.'assets/img/slideshow/room-slide3.jpg'; ?>"
                alt="beach side city view">
